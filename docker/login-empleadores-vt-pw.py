...
def main():
    with sync_playwright() as p:
        ...
        # Navegar a la URL
        url = "https://login-empleadores.isaprevidatres.cl/login/"
        page.goto(url)
        ...
        try:
            ...
            page.fill("#rutempresa", os.getenv('LOGIN_EMP_VT_RUTEMP'))

            page.wait_for_selector("#rutusuario", state="visible")
            page.fill("#rutusuario", os.getenv('LOGIN_EMP_VT_RUTUSR'))

            page.wait_for_selector("#current-password", state="visible")
            page.fill("#current-password", os.getenv('LOGIN_EMP_VT_PASS'))
            ...
            if keyword in element_text:
                ...
                screenshot_path = "lastrun/login-empleadores-vt.png"
